...
export default function App() {
  ...
  // ✅ FIX 1: submitEmail unificada en una sola función (era doble/anidada)
  // ✅ FIX 2: emailError ahora se usa para validar antes de enviar
  async function submitEmail(e: React.FormEvent) {
    ...
    try {
      // PRIMERO: suscribir a MailerLite (prioritario)
      ...
      // DESPUÉS: enviar email con Resend (fallo no bloquea)
      try {
      ...
      setEmailError("Hubo un problema. Por favor intentá de nuevo.");
    } finally {
      setSending(false);
    }
  }
  // ✅ FIX 3: App cierra correctamente aquí abajo, ANTES de los componentes auxiliares
