...
export default function App() {
  ...
  // ✅ FIX 1: restart movida fuera de submitEmail, al cuerpo de App
  function restart() {
    setStep("intro");
    setCurrent(0);
    setAnswers([]);
  ...
  // ✅ FIX 2: submitEmail ahora cierra correctamente con } al final
...
function BrainLogo({ className = "w-8 h-8" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M100 170 C90 160, 80 150, 75 135 C60 100, 55 80, 60 60 C65 40, 80 25, 100 25 C120 25, 135 40, 140 60 C145 80, 140 100, 125 135 C120 150, 110 160, 100 170Z"
        stroke="currentColor"
        strokeWidth="3"
        strokeLinecap="round"
      />
      <path
        d="M85 130 C90 115, 95 100, 100 85 C105 70, 100 55, 95 45"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      <path
        d="M115 130 C110 115, 105 100, 100 85 C95 70, 100 55, 105 45"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      <path
        d="M70 80 C80 75, 85 65, 85 55"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M130 80 C120 75, 115 65, 115 55"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M78 110 C85 105, 90 95, 92 85"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M122 110 C115 105, 110 95, 108 85"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
    ...
    <div className="w-full">
      <div className="rounded-[28px] border border-[#e6d6c3] bg-white/70 p-8 shadow-[0_30px_80px_-30px_rgba(120,80,50,0.25)] backdrop-blur-sm sm:p-14">
        ...
        <p className="mt-6 max-w-xl text-base leading-relaxed text-[#6b5d52] sm:text-lg">
          ...
          <span className="font-medium text-[#3a2f28]">perfil de autoestima</span>{" "}
          con un resultado personalizado y una invitación para tu próximo paso de
          bienestar emocional.
        </p>
        ...
        <div className="mt-8 flex items-center gap-3 border-t border-[#e6d6c3] pt-6">
          ...
          <p className="text-xs leading-relaxed text-[#8a7868]">
            <span className="font-medium text-[#6b5d52]">Regalo de bienvenida</span>{" "}
            — Al finalizar recibís tu perfil detallado con ejercicios para empezar
            hoy mismo.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-[28px] border border-[#e6d6c3] bg-white/75 p-8 shadow-[0_30px_80px_-30px_rgba(120,80,50,0.25)] backdrop-blur-sm sm:p-14">
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4">
          ...
          <button
            type="submit"
            disabled={sending}
            className="group inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#3a2f28] px-8 py-4 text-sm font-medium tracking-wide text-[#f9f4ec] transition hover:bg-[#b07560] disabled:opacity-70 sm:w-auto"
          >
        ...
        <div className="mt-6 flex items-center gap-3 border-t border-[#e6d6c3] pt-5">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#3a2f28] text-[#e6d6c3]">
            <BrainLogo className="h-4 w-4" />
          </div>
          <div>
            <p className="text-xs font-medium text-[#3a2f28]">
              Lic. Psi. Camila Pizzani
            </p>
...
} // ← llave de cierre de EmailGate

// ✅ FIX 3: Result definido como componente independiente fuera de EmailGate
function Result({
  name,
  score,
  profile,
      ...
      <div className="overflow-hidden rounded-[28px] border border-[#e6d6c3] bg-white/80 shadow-[0_30px_80px_-30px_rgba(120,80,50,0.3)] backdrop-blur-sm">
        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="mt-10 rounded-2xl border border-dashed border-[#d9c2a8] bg-[#fbf5ec] p-6">
            <div className="mb-2 text-[10px] uppercase tracking-[0.35em] text-[#b07560]">
              Tu siguiente paso
            </div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              ...
              className="group inline-flex flex-1 items-center justify-center gap-3 rounded-full bg-[#25D366] px-6 py-4 text-sm font-medium tracking-wide text-white transition hover:bg-[#1ebc57]"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex flex-1 items-center justify-center gap-3 rounded-full border-2 border-[#006BFF] bg-transparent px-6 py-4 text-sm font-medium tracking-wide text-[#006BFF] transition hover:bg-[#006BFF] hover:text-white"
            >
              <svg
                className="h-5 w-5"
                fill="none"
          ...
          <div className="mt-8 rounded-2xl border border-[#e6d6c3] bg-[#f9f4ec] p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-[#3a2f28]">
                  Lic. Psi. Camila Pizzani
                </p>
                <p className="text-[11px] text-[#8a7868]">
                  @asesoramientopsi · SanaMente Consulta
                </p>
              </div>
            </div>
            <p className="mt-3 text-xs leading-relaxed text-[#6b5d52]">
              Este test es una herramienta orientativa y no reemplaza una
              evaluación profesional. Si sentís que necesitás acompañamiento,
              escribime por WhatsApp o agendá una cita conmigo.
            </p>
          </div>
