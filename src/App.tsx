    ...
    <div className="w-full">
      <div className="rounded-[28px] border border-[#e6d6c3] bg-white/70 p-8 shadow-[0_30px_80px_-30px_rgba(120,80,50,0.25)] backdrop-blur-sm sm:p-14">
        ...
        <p className="mt-6 max-w-xl text-base leading-relaxed text-[#6b5d52] sm:text-lg">
          ...
          con un resultado personalizado y una invitación para tu próximo paso de bienestar emocional.
        </p>
          ...
          {question.options.map((opt, i) => {
            ...
            return (
              <button
                ...
                className={`group flex w-full items-center justify-between gap-4 rounded-2xl border px-5 py-4 text-left transition-all ${isSelected ? "border-[#b07560] bg-[#f1e2cf] shadow-sm" : "border-[#e6d6c3] bg-white/60 hover:border-[#c98e7a] hover:bg-[#faf2e6]"}`}
              >
                <div className="flex items-center gap-4">
                  <span className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full border text-[10px] font-medium tracking-wider transition ${isSelected ? "border-[#b07560] bg-[#b07560] text-white" : "border-[#c9b9a8] text-[#8a7868] group-hover:border-[#b07560] group-hover:text-[#b07560]"}`}>
    ...
    <div className="w-full">
      <div className="rounded-[28px] border border-[#e6d6c3] bg-white/75 p-8 shadow-[0_30px_80px_-30px_rgba(120,80,50,0.25)] backdrop-blur-sm sm:p-14">
        ...
        <h2 className="font-serif text-3xl leading-[1.1] text-[#3a2f28] sm:text-5xl">
          Tu resultado está<br />
          <span className="italic text-[#b07560]">listo para vos</span>
        </h2>
        <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-[#6b5d52]">
          Dejame tu nombre y tu mejor email. Te muestro tu perfil ahora mismo y te envío el PDF completo con ejercicios para llevarte.
        </p>
    ...
    <div className="w-full">
      <div className="overflow-hidden rounded-[28px] border border-[#e6d6c3] bg-white/80 shadow-[0_30px_80px_-30px_rgba(120,80,50,0.3)] backdrop-blur-sm">
        <div className="border-b border-[#ecdcc8] bg-gradient-to-br from-[#f7ead9] to-[#efddc6] p-8 sm:p-12">
          ...
          <h2 className="font-serif text-3xl leading-[1.1] text-[#3a2f28] sm:text-5xl">
            {name ? `${name}, ` : ""}<span className="italic">{profile.title.toLowerCase()}</span>
          </h2>
        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a href={CALENDLY} target="_blank" rel="noopener noreferrer" className="inline-flex flex-1 items-center justify-center gap-3 rounded-full border-2 border-[#006BFF] bg-transparent px-6 py-4 text-sm font-medium tracking-wide text-[#006BFF] transition hover:bg-[#006BFF] hover:text-white">
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01M16 18h.01" /></svg>
              Agendar Cita
            </a>
          </div>
          ...
          <div className="mt-8 rounded-2xl border border-[#e6d6c3] bg-[#f9f4ec] p-5">
            ...
            <p className="mt-3 text-xs leading-relaxed text-[#6b5d52]">
              Este test es una herramienta orientativa y no reemplaza una evaluación profesional. Si sentís que necesitás acompañamiento, escribime por WhatsApp o agendá una cita conmigo.
            </p>
          </div>
      ...
      <div className="mt-6 rounded-2xl border border-[#e6d6c3] bg-white/60 p-5 text-center backdrop-blur-sm">
        <p className="text-xs tracking-wider text-[#6b5d52]">
          ...
          <a href="https://www.instagram.com/asesoramientopsi/" target="_blank" rel="noopener noreferrer" className="font-medium text-[#b07560] underline-offset-4 hover:underline">Compartir el test →</a>
        </p>
      </div>
    </div>
  );
